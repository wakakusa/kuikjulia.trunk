 ...
 **********************************************************************************************/
void create_Read_Delim_filechooserdialog2(StructPalletWidget *struct_widget,char UI_FILE[256],char Window_name[512])
{
  GtkBuilder *builder;
  GError* error = NULL;
  ...
  (struct_widget->check_button1) = GTK_CHECK_BUTTON(gtk_builder_get_object(builder, "Read_Delimfile_chooserdialog2_checkbutton1"));
  (struct_widget->check_button2) = GTK_CHECK_BUTTON(gtk_builder_get_object(builder, "Read_Delimfile_chooserdialog2_checkbutton2"));
  (struct_widget->check_button3) = GTK_CHECK_BUTTON(gtk_builder_get_object(builder, "Read_Delimfile_chooserdialog2_checkbutton3"));
  (struct_widget->entry1) 		 = GTK_ENTRY(gtk_builder_get_object(builder, "Read_Delimfile_chooserdialog2_entry1"));
  (struct_widget->entry2) 		 = GTK_ENTRY(gtk_builder_get_object(builder, "Read_Delimfile_chooserdialog2_entry2"));
  (struct_widget->entry3) 		 = GTK_ENTRY(gtk_builder_get_object(builder, "Read_Delimfile_chooserdialog2_entry3"));
  (struct_widget->entry4) 		 = GTK_ENTRY(gtk_builder_get_object(builder, "Read_Delimfile_chooserdialog2_entry4"));
 ...
 * glade:none
 **********************************************************************************************/
G_MODULE_EXPORT void Read_Delimfile_chooserdialog2_FileOpen_OK (GtkWidget *widget,gpointer data  )
{
 //読み込み対象ファイル名を取得
...
{
  create_Read_Delim_filechooserdialog2(&Pallet_Read_Data,PalletInterfaceFile02,"Read_Delimfile_chooserdialog2");
